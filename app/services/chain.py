...
class AiactService:
    def __init__(self, llm):
        ...
        self.second_stage_prompt = PromptTemplate(
            template             = """Using the provided extract from the AI Act legislation and the outlined project key AI functionalities, your task is to create a LONG AND EXTENSIVE compliance guide. This guide should detail the necessary steps to align with the requirements of the AI Act. Please mention the articles of the AI Act that where used in the extract and as the basis for the compliance guide. (The number/reference of the articles should be listed after the compliance requirements)
